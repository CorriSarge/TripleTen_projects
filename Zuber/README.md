...
| 2 | [Requirements.txt](https://github.com/CorriSarge/TripleTen_projects/blob/main/Zuber/Requirements) | A simple .txt file with the provided project requirements as provided by TripleTen. |
| 3 | [Table Scheme.png](https://github.com/CorriSarge/TripleTen_projects/blob/main/Zuber/Table%20Scheme.png) | A .png file showing the relationships between tables used in this project. |
